...
Revision ID: 7c1ceb739b80
Revises: 
Create Date: 2026-02-28 13:04:40.086564
...
def upgrade():
    ...
    sa.Column('tenant_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenant.id'], name='fk_user_tenant_id', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenant.id'], name='fk_product_instance_tenant_id', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['customer_id'], ['customer.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['product_instance_id'], ['product_instance.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['moved_by'], ['user.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['product_instance_id'], ['product_instance.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('tenant_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['instance_id'], ['product_instance.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenant.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['invoice_id'], ['invoice.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['product_instance_id'], ['product_instance.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['sale_id'], ['sale_transaction.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
